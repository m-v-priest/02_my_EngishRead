...
image:../../+ img_单词图片/y/yardstick.jpg[]
...
image:../../+ img_单词图片/c/circumvent.jpg[]

1. 特朗普试图让半导体行业去中国化，可能反而会让半导体行业去美国化。
