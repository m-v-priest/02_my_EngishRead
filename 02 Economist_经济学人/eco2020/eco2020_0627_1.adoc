...
新广告人
广告业务正变得不那么循环——而且更加集中
随着越来越多的营销活动在网上展开，这些数字巨头对adland的征服看起来势不可挡
2020年6月27日|
忧郁的钢琴音乐吗?检查。荒凉街道的镜头?检查。伤感的画外音在哀叹“不确定的时代”?检查。为了能在大流行中播出电视广告，从AT&T到百威，各大品牌都派来了最好的广告人。所有人似乎都说出了同样的陈词滥调，宣称:“我们在一起。”
今年对广告来说是艰难的一年，而且不仅仅是在创意方面。据全球比林斯最大的广告公司群邑(GroupM)预计，全球广告支出将比2019年下降10%。大流行导致广告商削减营销预算，剥夺了影院等销售商的广告空间和观众，也让广告商无事可做。世界第三大机构阳狮集团的顾问Rishad Tobaccowala将其比作一次小行星撞击:“地球将继续存在。但是一些恐龙会死去。”
随着尘埃落定，一个重塑的广告世界正在出现。买家们正在低调行事，但似乎准备大肆挥霍。他们的大部分钱将第一次在网上使用。长期衰落的离线广告销售商和创意公司，其中间商业务受到双方的挤压，正面临着逐渐的消亡。
尽管出现了前所未有的衰退，但今年广告支出的降幅可能会低于2009年金融危机后11.2%的降幅。一家研究公司MoffettNathanson认为，尽管在2001年和2009年的经济衰退期间，大部分的广告支出再也没有恢复，但这一次的广告支出最早在明年就会恢复到大流行前的水平(见表1)。如何来吗?一句话:互联网。
2001年,当谷歌是启动和马克·扎克伯格在高中,数字广告占美国的广告组合的5%(见图表2)。在2010年广告商花了两倍的印刷品和广播网络,尽管人们花更多的时间在电脑和智能手机比在杂志或收音机。最终，那些在经济低迷时期停止广播和印刷广告的公司意识到他们并不需要这些广告。
他们更不愿意削减在线广告。另一家大型广告公司Interpublic的研究机构麦格纳预计，今年传统的广告形式正在遭受传统的打击——印刷广告将下降32%，而数字广告将持平，甚至有所上升。互联网吸引了新的广告商，并说服现有的广告商花更多的钱。那些无法支付昂贵的电视片段的小公司可以负担得起在线试验。美国电视网络上最大的100家广告商占据了超过70%的广告销售份额，但在搜索和Facebook上，前100名的份额分别是26%和20%。公司也将他们的“线下”营销预算——如直接邮寄和店内促销——转移到网上。科技巨头提供的分析鼓励买家继续播放广告，直到投资回报出现下降迹象。越来越多只存在于互联网上的公司无法轻易削减在线广告。研究公司Bernstein的Mark Shmulik说，对他们来说，数字广告是“新的租金”。在线零售商节省了实体店，但必须保持看得见的虚拟存在，无论经济衰退与否。
与此同时，每个人都受到近乎双头垄断的支配。谷歌和Facebook这两家业主控制了全球60%的数字广告地产。投资者渴望谷歌在其地图应用程序中引入广告。根据研究公司eMarketer的数据，由于谷歌今年在美国的净广告收入预计将下降4%，他们的呼声可能会越来越高。Facebook可以在Instagram上发布更多信息。伯恩斯坦表示，同样隶属于Facebook的WhatsApp是“现存的货币化程度最低的应用”。

媒人
数字广告支出的反弹还有一个最终也是最重要的原因。投资公司Bond Capital的玛丽•米克指出，十年前，它与人们的实际媒体习惯没有多大关系，而今天，它与人们如何打发时间密切相关(见图3)。
这些习惯的进一步发展也将有利于数字广告。移动屏幕已经取代电视，成为人们注意力的最大吸引者。甚至在大流行之前，每年都有更多的美国人取消有线电视合同。现在，囊中羞涩的消费者正纷纷转向更便宜的流媒体服务，比如Netflix。MoffettNathanson预测，在接下来的几年里，一直表现良好的电视广告“将最终开始崩溃”。
随着更多的广告资金转移到网络上，谷歌和Facebook将迎来更大的冲击，据伯恩斯坦(Bernstein)称，这两家公司去年占据了新增在线广告支出的90%。几年内，他们将在全球数字广告业务中占据70%的份额，并且仍有足够的能力展示更多的广告(见图4)。
不过，eMarketer的安德鲁•利普斯曼(Andrew Lipsman)警告称，如果在线广告支出的洪流持续下去，目前的数字广告空间可能会达到“饱和点”。广告随后会渗透到其他数字媒体上。
其中一个是游戏，自从1993年艺电(Electronic Arts)在其第一款“国际足联”(FIFA)足球比赛中播放了路边广告以来，这个行业已经有了长足的发展。去年，制作“糖果粉碎传奇”游戏的King公司获得了1.5亿美元的净广告预订量。如今，游戏公司让广告更吸引人，比如让玩家通过观看广告来获得升级。King称，消费者在《糖果粉碎传奇》中看到的广告比在流媒体或社交媒体上看到的广告更容易记住18%。King的母公司动视暴雪(Activision Blizzard)的营销主管乔纳森•斯特林菲尔德(Jonathan Stringfield)回忆起六七年前，他不得不说服持怀疑态度的广告客户，让他们相信Facebook是一个推广品牌的重要场所。他当时在Facebook工作。他表示:“这真的像是(在游戏领域)历史在重演。”
视频流，如果有的话，似乎准备好了一个更大的财源。奈飞公司坚称它永远不会播放商业广告。但是其他的流媒体，包括迪斯尼的Hulu和nbc环球的孔雀，已经有了广告的支持。随着流媒体战争的升温，基于订阅的服务可能会决定出售广告，以资助他们对新内容的投资。
然后是亚马逊。在数字广告领域，这个电子帝国仍然排在第三位，但发展迅速。它蚕食了一大块谷歌的搜索业务:现在超过一半的在线产品搜索是在亚马逊上进行的。它的广告特别有效:购物者来到网站准备购买，它的购买历史数据使它能够精确定位消费者。它还没有在Prime视频服务上播放广告。但Lipsman先生说，如果这样的话，广告收入将会滚滚而来。看到广告的观众可以不用离开应用程序就能在亚马逊上下订单，或者通过语音控制，抬起手指就能下单。利普斯曼预计，亚马逊将在两三年内在Prime视频上销售广告。它的两大科技竞争对手，通过Facebook商店和谷歌购物，希望以比广告扩张更快的速度打入零售市场。
广告人的科技巨头窃取业务,也方便广告主创建自己的广告。在英国只有13%的在线搜索广告和44%的在线显示广告经过五大机构,处理大多数的电视广告,根据恩德斯分析,研究公司。五巨头——wpp(拥有GroupM)、宏盟(Omnicom)、阳狮(Publicis)、Interpublic和电通(dentsu)——的股价至少三年来持平或下滑;所有的国家都在这场大流行中跳水。
这些评级机构正在反击，提供更多的数据分析，并将自己定位为更广泛的品牌咨询公司。自2006年以来，阳狮集团已斥资150亿美元收购这些领域的专业公司。Tobaccowala先生估计现在只有35-40%的集团业务是传统广告。咨询公司则向相反的方向扩张;埃森哲在过去十年间收购了二十多家广告公司。Tobaccowala先生相信他的产业可以避开这颗小行星。“代理机构就像蟑螂，而不是恐龙，”他说。“我们四处奔波，探索新世界。如今，这被视为乐观。
