...
Such effects *will be compounded* 使加重；使恶化;混合；掺和；拌和 as the vast support(n.) provided by governments *is rolled back* 逐渐减少;逐步结束. [Since March] the authorities *have propped up* 支撑 commercial tenants *by paying employees’ wages*, *topping up* 装满，注满（未满的容器）;补足；将…增加到所需的量 business cash reserves 现金储备, *legislating 制定法律；立法 against* eviction 驱逐, *backstopping 支持 banks* and *reducing credit constraints* 限制；限定；约束, 严管. Most measures *are set to expire （因到期而）失效，终止；到期 within months*. Coface, a trade-credit 商业信用；贸易信贷 insurer, *expects* insolvencies *to jump* by a third worldwide by 2021. Landlords could find that rental income dries up just as lenders, tolerant thus far, lose patience. Without progress on a vaccine or a treatment over the next three to six months, says Michael Van Konynenburg of Eastdil Secured, a bank, “we’ll start to see more enforcement actions”.
