...
一旦人们接受了竞争在劳动力市场中的作用，有关最低工资的辩论就会变得更加细致入微，更加经验性。收集数据并不容易。研究人员必须考虑是否跟踪工作或工人，是否研究特定群体，如青少年或无技能的人，还是更广泛的行业。影响就业市场的不仅仅是最低工资规定。构建合理的反事实是困难的。

特定的西北部
考虑一个来自西雅图的例子。这座城市一直处于“争取15美元”运动的最前沿，正是这一运动促成了拜登的承诺。该市工资的快速上涨使其成为了一个颇具吸引力的经济研究实验室，尽管有些人抱怨说，这一事实并不具有代表性。华盛顿大学(University of Washington)的叶卡捷琳娜•雅迪姆(Ekaterina Jardim)等人2017年发表的一篇论文发现，该市2015年和2016年最低工资的提高，导致低收入行业的雇主减少了工作时间。低收入工人的平均时薪更高，但由于工作时间减少，他们的月收入减少了74美元——相当于5小时的工资。
这篇论文使用了各行业工时和收入的综合数据。在2018年发表的一篇论文中，这些作者使用行政数据来追踪单个员工，而不是观察平均水平。这一次，他们发现低收入工人每周的收入增加了8-12美元。不过，大部分增长来自经验水平中值以上的低收入者，还有一部分来自那些在西雅图和华盛顿州其他地方加班弥补工作时间损失的工人。
